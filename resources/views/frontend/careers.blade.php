            ...
            <div class="row sakhuja-ceo">
                ...
                <div class="col-md-4 offset-md-1 text-center">
                    <img class="c-image mb-4 wow fadeInUp" data-wow-delay="100ms"
                        src="{{ url('frontend/imgs/mayanksakhuja.jpg') }}" alt="">
        ...
        <div class="container">
            ...
            <div class="row mb-md-5">
                <div class="col-md-4 p-md-0">
                    <img class="company-emp-heading2 cong1  mb-md-5 mb-3 wow fadeInLeft" data-wow-delay="100ms"  src="{{ url($employeeOfTheMonth->employeeimage1) }}" alt="">
                </div>
                <div class="col-md-4 p-md-0">
                    <img class="company-emp-heading2 cong2 mb-md-5 mb-3 wow fadeInUp" data-wow-delay="100ms" src="{{ url($employeeOfTheMonth->employeeimage2) }}" alt="">
                </div>
                <div class="col-md-4 p-md-0">
                    <img class="company-emp-heading2 cong3 mb-md-5 mb-3 wow fadeInRight" data-wow-delay="100ms" src="{{ url($employeeOfTheMonth->employeeimage3) }}" alt="">
                </div>
            </div>
            <div class="row mb-md-5">
                <div class="col-md-4 p-md-0">
                    <img class="company-emp-preformer1  mb-md-5 mb-3 wow fadeInUp" data-wow-delay="200ms"
                        src="{{  url($performerOfTheMonth->employeeimage1)  }}" alt="">
                </div>
                <div class="col-md-4 p-md-0">
                    <img class="company-emp-preformer2 mb-md-5 mb-3 wow fadeInUp" data-wow-delay="200ms"
                        src="{{ url($performerOfTheMonth->employeeimage2) }}" alt="">
                </div>
                <div class="col-md-4 p-md-0">
                    <img class="company-emp-preformer1 mb-md-5 mb-3 wow fadeInUp" data-wow-delay="200ms"
                        src="{{ url($performerOfTheMonth->employeeimage3)  }}" alt="">
                </div>
            </div>
            ...
            <div class="row mb-5 align-items-end">
                ...
                <div class="col-xl-7 col-lg-6 text-lg-end text-center">
                    <img class="meet-team-img wow fadeInUp" data-wow-delay="300ms"
                        src="{{ url('frontend/imgs/Happy vibe.svg') }}" alt="">
                </div>
            ...
            <div class="row">
                @foreach($teams as $item)
                    <div class="col-lg-3 col-md-4 text-center mb-3">
                        <img class="c-image mb-2 wow fadeInUp" data-wow-delay="300ms"src="{{ url($item->employeeimage1) }}" alt="">
                                ...
                                <div class="marquee-inner to-left">
                                    <span>
                                        <div class="marquee-item"><img class=""
                                                src="{{ url('frontend/imgs/companyemp.jpeg') }}" alt=""></div>
                                        <div class="marquee-item"><img class=""
                                                src="{{ url('frontend/imgs/companyemp.jpeg') }}" alt=""></div>
                                        <div class="marquee-item"><img class=""
                                                src="{{ url('frontend/imgs/companyemp.jpeg') }}" alt=""></div>
                                    ...
                                    <span>
                                        <div class="marquee-item">
                                            <img class="" src="{{ url('frontend/imgs/companyemp.jpeg') }}"
                                                alt="">
                                        </div>
                                        <div class="marquee-item">
                                            <img class="" src="{{ url('frontend/imgs/companyemp.jpeg') }}"
