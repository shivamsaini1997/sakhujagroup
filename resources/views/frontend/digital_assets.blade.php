        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 p-0">
                    <lottie-player autoplay loop mode="normal" src="{{url('frontend/imgs/digital.json')}}"></lottie-player>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="digital-assets-youtube">
        <div class="container">
            <div class="row text-center mb-5">
                <div class="col-12">
                    <h2 class="wow fadeInUp" data-wow-delay="100ms"><img class="youtube-logo" src="{{url('frontend/imgs/youtube-logo.png')}}" alt="">Youtube</h2>
                </div>
            </div>
                    ...
                    <div class="digital-assets-box">
                        <div class="assets-img">
                            <a href="{{$item->channel_url}}" target="_blank">
                                <img class="wow fadeInUp" data-wow-delay="100ms" src="{{url($item->channel_logo)}}" alt="">
                            </a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <a href="{{$item->serial_url1}}" target="_blank">
                                <img class="wow fadeInUp" data-wow-delay="500ms" src="{{url($item->serial_thumbnail1)}}" alt="">
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="{{$item->serial_url2}}" target="_blank">
                                <img class="wow fadeInUp" data-wow-delay="600ms" src="{{url($item->serial_thumbnail2)}}" alt="">
                            </a>

                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="{{$item->serial_url3}}" target="_blank">
                                <img class="wow fadeInUp" data-wow-delay="700ms" src="{{url($item->serial_thumbnail3)}}" alt="">
                            </a>

                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="{{$item->serial_url4}}" target="_blank">
                                <img class="wow fadeInUp" data-wow-delay="800ms" src="{{url($item->serial_thumbnail4)}}" alt="">
                            </a>
        ...
        <div class="container pb-md-5">
            <div class="row mb-5 justify-content-center">
                <div class="col-lg-5 col-12 text-center">
                    <h2 class="wow fadeInUp" data-wow-delay="100ms" ><img class="youtube-logo" src="{{url('frontend/imgs/facebookicon.png')}}" alt="">Facebook</h2>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-6 wow fadeInUp" data-wow-delay="200ms" >
                    <a href="{{$item->channel_url}}" target="_blank" class="digital-assets-home-card position-relative">
                        <div class="img-wraap">
                            <img src="{{url($item->channel_logo)}}" alt="">
                        </div>
