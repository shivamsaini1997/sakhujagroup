        ...
        <div class="scroll-content">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="image-group wow fadeInRight" data-wow-delay="800ms">
                                <img class="imgabout " src="{{ url($home ? $home->whoweimage : "") }}"
                                alt="">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 mt-3">
                            <img class="archive-img  wow fadeInUp" data-wow-delay="400ms" src="{{ url($home ? $home->achievementsimage : "") }}" alt="">
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="our-production">
                ...
                <div class="container-fluid production-img">
                    <div class="row">
                        <div class="col-12 p-0">
                            <img src="{{url('frontend/imgs/Kosha Mangsho Sliders.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </section>
