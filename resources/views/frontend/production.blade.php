            ...
            <div class="row">
                <div class="col-12 p-0">
                    <video  class="videobanner"
                        src="{{url('frontend/video/Production.mp4')}}"
                        type="video/mp4"
                        autoplay
                        playsinline
                        loop
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 text-center production-imgs">
                    <img class="wow fadeInUp" data-wow-delay="100ms" src="{{url('frontend/imgs/videographer-concept.svg')}}" alt="">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-12">
                    <div class="innovative-slider">
                        @foreach ($innovative as $items)
                            <div> <img src="{{url($items->innovative_productions)}}" alt=""></div>
                        @endforeach
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="production-slider">
                        ...
                        <div>  <img src="{{url($item->studio_productions)}}" alt=""></div>
