...
<footer>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-4 about-footer footer-text mb-lg-0 mb-3">
                        @if($globalSetting)
                        <a href="{{url('/')}}">
                            <img class="footer-logo mb-2" src="{{url($globalSetting?$globalSetting->footerlogo : '')}}" alt="">
                        </a>
                        @endif
  ...
  <script src="{{url('frontend/js/anime.js')}}"></script>
  <script src="{{url('frontend/js/lottie-player.js')}}"></script>
