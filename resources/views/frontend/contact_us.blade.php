            ...
            <div class="col-md-6 pt-md-5">
                <div class="right-section-mail">
                    ...
                    <div class="mt-md-5 pt-md-5 mb-md-0 mb-5">
                        <img src="{{url('frontend/imgs/phone-image.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <select class="form-select" name="how_can_we_help" id="">
                                        ...
                                        <option value="Enquriy for Rights">Enquriy for Rights</option>
                                        ...
                                        <option value="Genrel Enquiry">Genrel Enquiry</option>
