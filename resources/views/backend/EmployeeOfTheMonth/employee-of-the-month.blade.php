                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($employeeOfTheMonth->employeeimage1) && $employeeOfTheMonth->employeeimage1)
                                        <img src="{{ url($employeeOfTheMonth->employeeimage1) }}" alt="Who we are Image" style="width: 200px; height: 100px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($employeeOfTheMonth->employeeimage2) && $employeeOfTheMonth->employeeimage2)
                                        <img src="{{ url($employeeOfTheMonth->employeeimage2) }}" alt="Who we are Image" style="width: 200px; height: 100px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($employeeOfTheMonth->employeeimage3) && $employeeOfTheMonth->employeeimage3)
                                        <img src="{{ url($employeeOfTheMonth->employeeimage3) }}" alt="Who we are Image" style="width: 200px; height: 100px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
