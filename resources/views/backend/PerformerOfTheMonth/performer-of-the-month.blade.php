                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($performerOfTheMonth->employeeimage1) && $performerOfTheMonth->employeeimage1)
                                        <img src="{{ url($performerOfTheMonth->employeeimage1) }}" alt="Who we are Image" style="width: 200px; height: 100px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($performerOfTheMonth->employeeimage2) && $performerOfTheMonth->employeeimage2)
                                        <img src="{{ url($performerOfTheMonth->employeeimage2) }}" alt="Who we are Image" style="width: 200px; height: 100px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($performerOfTheMonth->employeeimage3) && $performerOfTheMonth->employeeimage3)
                                        <img src="{{ url($performerOfTheMonth->employeeimage3) }}" alt="Who we are Image" style="width: 200px; height: 100px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
