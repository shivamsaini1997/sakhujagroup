                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($homepage->bannervideo) && $homepage->bannervideo)
                                        <video src="{{ url($homepage->bannervideo) }}" type="video/mp4" width="200px" height="110px" controls>
                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($homepage->whoweimage) && $homepage->whoweimage)
                                        <img src="{{ url($homepage->whoweimage) }}" alt="Who we are Image" style="width: 200px; height: 100px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-6">
                            ...
                            <div class="col-lg-4 col-md-6 pt-4">
                                <div class="mb-3 position-relative">
                                    @if (isset($homepage->achievementsimage) && $homepage->achievementsimage)
                                        <img src="{{ url($homepage->achievementsimage) }}" alt="Achievements Image" style="width: 150px; height: 60px; object-fit: contain;">
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-8 col-md-6">
