                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img style="width: 90px; height:90px" src="{{url($item->channel_logo)}}" alt="">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <img style="width: 90px; height:90px" src="{{url($item->serial_thumbnail1)}}" alt="">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <img style="width: 90px; height:90px" src="{{url($item->serial_thumbnail2)}}" alt="">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <img style="width: 90px; height:90px" src="{{url($item->serial_thumbnail3)}}" alt="">
                                    ...
                                    <td>
                                        <img style="width: 90px; height:90px" src="{{url($item->serial_thumbnail4)}}" alt="">
