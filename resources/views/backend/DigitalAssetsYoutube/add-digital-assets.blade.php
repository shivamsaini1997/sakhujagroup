                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                @if(isset($youtubedigitalassets))
                                    <img src="{{url($youtubedigitalassets->channel_logo)}}" alt="" style="width: 120px;height: 80px;object-fit: contain;">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                @if(isset($youtubedigitalassets))
                                    <img src="{{url($youtubedigitalassets->serial_thumbnail1)}}" alt="" style="width: 120px;height: 80px;object-fit: contain;">.
                                @endif
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                @if(isset($youtubedigitalassets))
                                <img src="{{url($youtubedigitalassets->serial_thumbnail2)}}" alt="" style="width: 120px;height: 80px;object-fit: contain;">
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-12 form-group">
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                @if(isset($youtubedigitalassets))
                                    <img src="{{url($youtubedigitalassets->serial_thumbnail3)}}" alt="" style="width: 120px;height: 80px;object-fit: contain;">
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-12 form-group">
                        ...
                        <div class="col-lg-2">
                            <div class="mb-3">
                                @if(isset($youtubedigitalassets))
                                    <img src="{{url($youtubedigitalassets->serial_thumbnail4)}}" alt="" style="width: 120px;height: 80px;object-fit: contain;">
                                @endif
                            </div>
                        </div>
                        <div class="col-lg-12 form-group">
