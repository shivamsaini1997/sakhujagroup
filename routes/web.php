...
Route::middleware('auth')->group(function(){
    ...
    Route::post('/admin/add-digital-assets-youtube', [AdminController::class, 'storeAssetsYoutube'])->name('add-assets-youtube');
    ...
    Route::post('/admin/add-digital-assets-facebook', [AdminController::class, 'storeAssetsFacebook'])->name('add-assets-facebook');
    ...
    Route::post('/admin/add-innovative-productions', [AdminController::class, 'storeInnovativeProductions'])->name('add-Innovative-productions');
    ...
    Route::post('/admin/add-productions-studio', [AdminController::class, 'storeProductionsStudio'])->name('add-productions-studio');
    ...
    Route::post('/admin/add-catalogue', [AdminController::class, 'storeCatalogue'])->name('add-catalogue');
    ...
    Route::post('/admin/add-team', [AdminController::class, 'storeTeam'])->name('add-team');
